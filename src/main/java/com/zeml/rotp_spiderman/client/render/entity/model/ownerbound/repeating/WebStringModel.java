package com.zeml.rotp_spiderman.client.render.entity.model.ownerbound.repeating;
...
public class WebStringModel<T extends OwnerBoundProjectileEntity> extends RepeatingModel<T> {
	private final ModelRenderer string;

	public WebStringModel() {
		texWidth = 32;
		texHeight = 32;
